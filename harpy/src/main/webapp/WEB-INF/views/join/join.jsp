	...
	<div class="row">
		<div class="col-xs-12 col-sm-12 col-md-4 well well-sm">
			...
			<form action="#" method="post" class="form" role="form">
				...
				<label class="radio-inline"> <input type="radio" name="sex" id="inlineCheckbox1" value="male" /> Male </label>
				<label class="radio-inline"> <input type="radio" name="sex" id="inlineCheckbox2" value="female" /> Female </label>
				<br /><br />
