...
public class ObjectUtil {
	static final Logger log = LoggerFactory.getLogger(ObjectUtil.class);
	 ...
	 * Object [] params = new Object []{getDataSource(),
	 * getUsersByUsernameQuery()}; this.usersByUsernameMapping =
	 ...
	 * @throws Exception
	 */
	public static Object instantiate(String className, String[] types, Object[] values) throws ClassNotFoundException, InstantiationException,
